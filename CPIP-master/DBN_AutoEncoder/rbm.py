    ...
    def train(self,X):
        ...
        for i in range(self.numepochs):
            ...
            for v in X:
                ...
                self.h1 = self.sigm(self.c+np.dot(self.v1,self.W))
                self.v2 = self.sigm(self.b+np.dot(self.h1,self.W.T))
                self.h2 = self.sigm(self.c+np.dot(self.v2,self.W))
